...
readonly CONFIG=(
  "8jre/alpine/hotspot"
    ...
    "-Xmx4096M -XX:+UnlockExperimentalVMOptions -XX:+UseG1GC -XX:+UseStringDeduplication -XX:+UseCGroupMemoryLimitForHeap"
  "8jre/alpine/openj9"
    "adoptopenjdk/openjdk8-openj9:alpine-jre"
    "-Xmx4096M -Xmns2048M -Xmnx3276M -Xgc:concurrentScavenge -Xgc:dnssExpectedTimeRatioMaximum=3 -Xgc:scvNoAdaptiveTenure -Xdisableexplicitgc -Xtune:virtualized"
